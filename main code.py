...
b.place(x=300,y=230)
b_txt=Entry(root,font=('times new rommon',20,'bold'),fg='red',justify=CENTER,relief=GROOVE,textvariable=lblbinary)
b_txt.place(x=650,y=230)

d=Label(root,text='decimal',font='arial 20 bold')
d.place(x=300,y=310)
d_txt=Entry(root,font=('times new rommon',20,'bold'),fg='red',justify=CENTER,relief=GROOVE,textvariable=lbldecimal)
